...
public class MainActivity extends FragmentActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Options du menu laterale. Definition dde leur emplacement et leur chiffre correspondante pour la selection du kml suivante
		// Home
	...
	private void displayView(int position) {
		// update the main content by replacing fragments. The most part are HomeFragment with the correspondant value who will define which Kml is charged
